    ...
    <div id="application-preview" class="application-form">
        ...
        <table>
            ...
            <tr>
                ...
                <td>{{ ucfirst($record->applicant_marital_status) }}</td>
            </tr>
        ...
        <table style="margin-top: 24px;">
            <tr class="section-title">
                <td colspan="4" style="text-align: center;">Parent Details</td>
            </tr>
            <tr>
                <td>Name</td>
            ...
            <tr>
                <td style="">Patient Needs</td>
                <td colspan="3">{{ $record->patient_needs }}</td>
            </tr>
        </table>
