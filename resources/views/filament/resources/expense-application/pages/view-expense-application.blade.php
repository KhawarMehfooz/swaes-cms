<x-filament-panels::page>
    ...
    <div id="application-preview" class="application-form">
        ...
        <h3 style="text-align:center; margin: 16px 0; font-size: 22px; font-weight: bold;">Approved Expenses and Details
        </h3>
        ...
        <table>
            <tr class="section-title">
                <td colspan="4" style="text-align: center;">Store Details</td>
            </tr>
            <tr>
                <td colspan="">Store Name</td>
                <td colspan="">{{ $record->shop_name }}</td>
                <td colspan="">Store Address</td>
                <td colspan="">{{ $record->shop_address }}</td>
            </tr>
            <tr class="section-title">
                <td colspan="4" style="text-align: center;">Expenses Details</td>
    ...
    <script>
        ...
        function downloadPDF() {
            ...
            const opt = {
                margin: [0, 0, 0, 0],
                filename: '{{ $record->id }}_Expense_Application_SWAES.pdf',
