<x-filament-panels::page>
    ...
    <div id="application-preview" class="application-form">
        ...
        <h3 style="text-align:center; margin: 16px 0; font-size: 20px; font-weight: 600;">Free Books Scheme for Year
            <span class="">{{ $record->scheme_year }}</span>
        </h3>
        ...
        <table>
            ...
            <tr>
                <td>Books/Stationary/School Bags</td>
                <td colspan="3">{{ $record->stationary_details }}</td>
            </tr>
        </table>
    ...
    <script>
        ...
        function downloadPDF() {
            ...
            const opt = {
                margin: [0, 0, 0, 0],
                filename: '{{ $record->id }}_Books_Application_SWAES.pdf',
