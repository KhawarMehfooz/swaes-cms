...
namespace App\Filament\Resources\UniformApplications\Schemas;
            ...
            ->components([
                ...
                Section::make('Student Details')
                    ->schema([
                        ...
                        Repeater::make('uniform_details')
                            ->label('Uniform Details')
                            ->schema([
                                TextInput::make('item_name')
                                    ->required()
                                    ->label('Item Name'),
                                TextInput::make('item_detail')
                                    ->required()
                                    ->label('Item Detail'),
                            ])
                            ->columns(2)
                            ->columnSpanFull()
                            ->default([
                                ['item_name' => 'Pent', 'item_detail' => ''],
                                ['item_name' => 'Socks', 'item_detail' => ''],
                                ['item_name' => 'Shoes', 'item_detail' => ''],
                                ['item_name' => 'Tie', 'item_detail' => ''],
                            ]),
